...
char ch[80]="empty";
     switch (iMsg)
          ...
          case WM_CREATE :
			   ...
			   CreateWindow("button","верхн€€ кнопка",WS_CHILD|WS_VISIBLE|BS_DEFPUSHBUTTON,320,330,250,30,hwnd,(HMENU) ID_BUTTON1,hInstance,NULL);
               return 0 ;
		  ...
		  case ID_BUTTON1:
			  {
				...
				//  q=SetTextColor(w,q);
				  MessageBox(hwnd,"нажата верхн€€","message",MB_OK);
