...
LRESULT WINAPI wndProc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam)
{
	...
	switch (message) {
	case WM_CREATE:
		edit1 = CreateWindow(L"EDIT", L"Ââåäèòå ÷èñëî ñ íå÷åòíûì êîëè÷åñòâîì öèôð( íå 0! )", ES_LEFT | WS_BORDER | WS_VISIBLE | WS_CHILD, 0, 0, 400, 20, hwnd, (HMENU)EDIT_1, NULL, NULL);
