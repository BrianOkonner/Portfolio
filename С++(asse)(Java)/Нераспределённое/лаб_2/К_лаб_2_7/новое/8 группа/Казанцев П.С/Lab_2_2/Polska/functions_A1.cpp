...
void numbers_stack::push_n(double number)
{
...
double numbers_stack::element_n()
{
	return number_head->number;
}

void numbers_stack::show_numbers_stek()
{
...
void operations_stack::push(char operation)
{
...
char operations_stack::element()
{
	return head->operation;
}

void operations_stack::show_stek()
{
...
double value_of_opn(char *str_opn)
{
	...
	while (tmp)
	{
		...
		else
		{
			...
			case '+':
			{
				number_head->push_n(number_head->pop_n() + number_head->pop_n());
				break;
			}
			case '-':
			{
				number_head->push_n((number_head->pop_n() - number_head->pop_n())*(-1));
				break;
			}
			case '*':
			{
			...
			case '/':
			{
				number_head->push_n((1 / number_head->pop_n())*number_head->pop_n());
						break;
			}
			case '^':
			{
						double temp_numb = number_head->pop_n();
						number_head->push_n(pow(number_head->pop_n(), temp_numb));
						break;
			}
			}
		}
